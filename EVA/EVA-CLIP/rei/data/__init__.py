...
def create_dataset_zero_shot(dataset, min_scale=0.5, low_resolution=128, dtd_split=1, org_resolution=336, root=None, enable_resize=True):
    ...
    if dataset=='imagenet1k':
        ...
        categories="~/LR0.FM/CLIP/dataloaders/classes/caltech101.txt"
        home_directory = os.path.expanduser('~')
        ...
        from data.real_world import REAL_WORLD
        test = REAL_WORLD(root=root, train=False, transform=transform_test)
    else:
