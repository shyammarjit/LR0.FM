...
def parse_args(args):
    ...
    parser.add_argument(
        "--dataset-type",
        choices=["webdataset", "csv", "synthetic", "auto", "lr_aug"],
        default="auto",
    ...
    parser.add_argument('--train-fn', type=str, default=None)
    parser.add_argument('--no-pin-memory', action="store_true", default=None)
    ...
    parser.add_argument('--disable-xattn', action='store_true', default=False)
    ...
    parser.add_argument("--e2e-fine-tuning", action='store_true', default=False, )
    parser.add_argument("--w-lr-tokens", action='store_true', default=False, )

    parser.add_argument("--lr-tokens-layer", type=int, default=-1)

    parser.add_argument("--lr_start", type=int, default=16, help="input image resolution for model",)
    parser.add_argument("--lr_end", type=int, default=32, help="input image resolution for model",)
