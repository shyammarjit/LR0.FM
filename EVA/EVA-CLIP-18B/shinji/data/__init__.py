...
def create_transformation_zero_shot(low_resolution=128, org_resolution=336):
    ...
    if low_resolution!=org_resolution:
        transform_test = transforms.Compose([
            ...
            transforms.Resize((org_resolution,org_resolution),interpolation=InterpolationMode.BICUBIC),
...
def create_dataset_zero_shot(dataset, min_scale=0.5, low_resolution=128, dtd_split=1, org_resolution=336):
    normalize = transforms.Normalize((0.48145466, 0.4578275, 0.40821073), (0.26862954, 0.26130258, 0.27577711))      
    if low_resolution!=org_resolution:
        transform_test = transforms.Compose([
            transforms.Resize((low_resolution, low_resolution),interpolation=InterpolationMode.BICUBIC),
    ...
    if dataset=='imagenet1k':
        ...
        test = Food101(root="./datasets/food-101/", train=False, transform=transform_test)
