...
def parse_args(args):
    ...
    parser.add_argument("--class_dir", type=str, default="/home/shyam/resolution-bm/MetaCLIP/dataloaders/classes/", help="input image resolution for model",)
    parser.add_argument("--templates_dir", type=str, default="/home/shyam/resolution-bm/MetaCLIP/dataloaders/templates", help="input image resolution for model",)
