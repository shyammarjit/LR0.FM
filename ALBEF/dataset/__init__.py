...
def create_dataset(dataset, config, low_resolution=128, original_resolution=384, root=None):
    ...
    if low_resolution!=original_resolution:
        test_transform = transforms.Compose([
            transforms.Resize((low_resolution, low_resolution),interpolation=Image.BICUBIC),
    ...
    if dataset=='pretrain':
        ...
        dataset = LR_dataset(root=root, transform=pretrain_transform)                  
        return dataset      
