...
if __name__ == '__main__':
    ...
    if args.checkpoint is None:
        if args.backbone=='albef_14M':
            args.checkpoint = extend_user_path('~/LR0.FM/ALBEF/checkpoints/ALBEF.pth')
        elif args.backbone=='albef_4M':
            args.checkpoint = extend_user_path('~/LR0.FM/ALBEF/checkpoints/ALBEF_4M.pth')
        elif args.backbone=='coco_finetuned':
            args.checkpoint = extend_user_path('~/LR0.FM/ALBEF/checkpoints/albef_coco_retrieval_lavis.pt')
        elif args.backbone=='flicker_finetuned':
            args.checkpoint = extend_user_path('~/LR0.FM/ALBEF/checkpoints/albef_flickr_retrieval_lavis.pt')
