...
def parse_args():
    ...
    parser.add_argument("--train-data", type=str, default=None, help="Path to csv filewith training data",)
    parser.add_argument(
        "--val-data",
        type=str,
        default=None,
    ...
    parser.add_argument(
        "--csv-separator", type=str, default="\t", help="For csv-like datasets, which separator to use."
    )
    parser.add_argument(
        "--csv-img-key", type=str, default="filepath", help="For csv-like datasets, the name of the key for the image paths."
    )
    parser.add_argument(
        "--csv-caption-key", type=str, default="title", help="For csv-like datasets, the name of the key for the captions."
    )
    ...
    parser.add_argument("--lr-mode", default=False, action="store_true")
    parser.add_argument("--class_dir", type=str, default="./MetaCLIP/dataloaders/classes/", help="input image resolution for model",)
    parser.add_argument("--templates_dir", type=str, default="./MetaCLIP/dataloaders/templates", help="input image resolution for model",)
    parser.add_argument("--low_resolution", type=int)
    parser.add_argument("--engine", type=str, default=None)

    parser.add_argument("--open-clip", default=False, action="store_true")
