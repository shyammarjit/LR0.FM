...
import open_clip, json, os, re, argparse
...
transform = preprocess # clip.resolution_transform(args.image_resolution, n_px_org=224)
...
dataset = flickr30k(transform, coco_root, coco_ann_file, target_transform=lambda texts: open_clip.tokenize(texts))
