...
class ImagenetA(Dataset):
    ...
    """
    def __init__(self, 
        root="/home/c3-0/datasets/imagenet-a", 
        train=True,
        class_info=None,
        transform=None,
    ):
        ...
        temp = os.path.join(self.root, "README.txt")
        if temp in imagnet_path_val:
            imagnet_path_val.remove(temp)
        val_images = []
        ...
        assert len(imagnet_path_val)==200 and len(val_images)==7500
