...
class Imagenet_V2(Dataset):
    ...
    """
    def __init__(self, 
        root="/home/c3-0/datasets/imagenetv2/tree/main/imagenetv2-matched-frequency", 
        train=True,
        class_info=None,
        transform=None,
    ):
        ...
        assert len(imagnet_path_val)==1000 and len(val_images)==10000
